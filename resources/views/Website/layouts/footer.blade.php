                ...
                <div class="col-xl col-lg-4 col-md-4 col-sm-6">
                    <div class="footer-links">
                        ...
                        <ul>
                            ...
                            <li><a href="#" class="text-light-white fw-600">Careers</a>
                            </li>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 text-center medewithlove align-self-center">
                    Designed &amp; Developed by <a href="https://www.webb4biz.com/" target="_blank">Webb4biz</a>
                </div>
                <div class="col-lg-4">
                    <div class="copyright-text"> <span class="text-light-white">© <a href="#" class="text-light-white">George Salek</a> - 2021 | All Right Reserved</span>
                    </div>
                </div>
            </div>
        </div>
