              ...
              <div class="login-box">
                  ...
                  <div class="row">
                    ...
                    <div class="col-12">
                      ...
                      <div class="form-group">
                        <label class="text-light-white fs-14">Delivery service city?</label>
                        <input type="text" name="city" class="form-control form-control-submit" required value="{{old('city')}} " >
                        @error('city')
                          <span class="text-danger">{{$message}} </span>
                        @enderror
                      </div>
